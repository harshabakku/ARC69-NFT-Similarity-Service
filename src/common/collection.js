...
indexFullCollection = async (collectionName) => { 
     try {
         ...
         if (nextToken) {
             ...
             console.log("Full Collection: All Assets,  Listings and Sales Have Been Indexed for collection: "+ collectionName + '\n\n\n\n\n')
             console.log('Next Data Check Again In ' + intervalDuration/1000 + ' secs again........... ');
 ...
 periodicIndexFullCollection = async (collection) => {
    
    //fetch and index data for the first time. //takes less than 2 min 
    console.log('Periodic Indexing collection: ' + collection);
    
    await indexFullCollection(collection);
    
            
    // setInterval is used to ingest data automatically in near real-time! //interval can be set to as low as 1min
...
module.exports = {
    indexFullCollection, periodicIndexFullCollection
}
